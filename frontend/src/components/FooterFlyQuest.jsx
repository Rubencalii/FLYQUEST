...
export default function FooterFlyQuest({ t }) {
  const socialLinks = [
    { 
      ...
      url: 'https://twitter.com/FlyQuest', 
    ...
    { 
      ...
      url: 'https://www.instagram.com/flyquest/', 
    ...
    { 
      ...
      url: 'https://www.youtube.com/c/FlyQuest', 
    ...
    { 
      ...
      url: 'https://www.twitch.tv/flyquest', 
      ...
      <div className="flex items-center justify-center gap-6 mb-4">
        {socialLinks.map(social => (
          <a
            ...
            title={social.name}
          >
            <div className="text-gray-600 dark:text-gray-400 hover:text-current transition-colors">
              {social.icon}
            </div>
